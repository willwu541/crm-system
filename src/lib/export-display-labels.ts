...
export const interestedProductLabel: Record<string, string> = {
  ...
  "Data Center Cable Trench": "数据中心线缆沟盖板 (Data Center Cable Trench)",
  "Warehouse Mezzanine / Platform": "仓储夹层/平台 (Warehouse Mezzanine / Platform)",
  "Solar Plant Walkway": "光伏电站走道 (Solar Plant Walkway)",
  "Offshore / Marine Platform": "海工/海上平台 (Offshore / Marine Platform)",
  "Wastewater Plant Grating": "污水处理厂格栅板 (Wastewater Plant Grating)",
  "Petrochemical Plant": "石化工厂平台 (Petrochemical Plant)",
  "Municipal Infrastructure": "市政基础设施 (Municipal Infrastructure)",
};
...
export const sourceChannelLabel: Record<string, string> = {
  ...
  "X (Twitter)": "X (Twitter)",
  Reddit: "Reddit",
  "Industry Directory": "行业名录/黄页",
  "B2B Database": "B2B 数据库",
  "Tender / Bid Platform": "招投标平台",
  "Cold Calling": "电话开发",
  "Trade Show": "展会",
